...
import com.sherbimet.user.Utils.BounceInterPolator;
...
public class SuccessMessageActivity extends BaseActivity {
    ...
    private void NavigateFromToScreen() {
        ...
        } else if (FromScreenName.equals("AddNewServiceRequestActivity") && ToScreenName.equals("HomeActivity")) {
            HandleClearAllScreenWithoutDataPassingNavigation(this, HomeActivity.class);
        } else if (FromScreenName.equals("BookingsAdapter") && ToScreenName.equals("BookingsActivity")) {
            HandleScreenNavigationWithoutDataPassing(this, BookingsActivity.class);
        } else if (FromScreenName.equals("RatingReviewBottomSheetDialogFragment") && ToScreenName.equals("BookingsActivity")) {
            HandleScreenNavigationWithoutDataPassing(this, BookingsActivity.class);
